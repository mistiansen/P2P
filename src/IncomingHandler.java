...
public class IncomingHandler implements Runnable { //realistically, this is an unnecessary class. Could put all this Connection.
    ...
    private void receive() {
        try {
            this.inbox.put(connection.receive());
...
//    private Message parseIncoming(byte[] msg) throws IOException { //put this in Connection
//
